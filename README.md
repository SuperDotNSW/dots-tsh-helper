...
# DISCLAIMER:
THIS BOT IS A PROOF-OF-CONCEPT, I do not recommend using this if you aren't involved with making it. Not because of some 'grahh i made it its my Intelectual Property >:(' type of stuff, just because it may cause more problems than it solves and there is not a formal 'How to Use' guide written by me beside just how to install it (and even that might not work properly, its mostly just to jog my memory if I ever need to install this on a separate machine).
