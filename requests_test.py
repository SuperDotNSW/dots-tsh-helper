...
class Ruleset():
    ...
    def update_from_tsh_data(self, webdata:dict):
        d = webdata['ruleset']
    ...
    def __init__(self, webdata:dict):
        self.update_from_tsh_data(webdata)
...
class State():
    ...
    def update_from_tsh_data(self, webdata:dict):
        ...
        p1.display_name = webdata['p1']
        p2.display_name = webdata['p2']
